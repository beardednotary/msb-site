      ...
      <div className="container mx-auto max-w-7xl px-6 py-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-10">
          <div className="flex flex-col gap-3">
            <h4 className="text-sm font-semibold text-white uppercase tracking-wider">App</h4>
            ...
            <a href="/#download" className="text-sm hover:text-emerald-400 transition-colors">
              Download Android <span className="text-xs text-slate-500">(coming soon)</span>
            </a>
          ...
          <div className="flex flex-col gap-3">
            ...
            >
              {/* Facebook icon (inline SVG — no Font Awesome dependency) */}
        ...
        {/* Bottom bar */}
        <div className="border-t border-slate-800 pt-6 text-sm text-center text-slate-500">
